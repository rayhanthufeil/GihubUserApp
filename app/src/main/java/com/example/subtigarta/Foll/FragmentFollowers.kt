...
import com.example.subtigarta.ViewModelUser
...
class FragmentFollowers : Fragment(R.layout.fragment_foll){
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.setFollowerUser(username)
        viewModel.getFollowerUser().observe(viewLifecycleOwner) {
            if (it != null) {
                showLoading(false)
                Log.e("rusak", "$it")
